...
COD_AREA_CONHECIMENTO INT REFERENCES AREA_CONHECIMENTO NOT NULL)

CREATE TABLE EXEMPLAR (
COD_EXEMPLAR INT PRIMARY KEY,
COD_TITULO INT REFERENCES TITULOS NOT NULL)
...
COD_USUARIO INT REFERENCES USUARIO NOT NULL,
COD_EXEMPLAR INT REFERENCES EXEMPLAR NOT NULL,
COD_TITULO INT REFERENCES TITULOS NOT NULL,
...
COD_EDITORA INT REFERENCES EDITORAS NOT NULL,
COD_TITULO INT REFERENCES TITULOS NOT NULL,
UNIQUE (COD_EDITORA, COD_TITULO))

CREATE TABLE EDITOR_REVISTA (
COD_EDITOR INT REFERENCES EDITOR NOT NULL,
COD_REVISTA INT REFERENCES REVISTA NOT NULL,
UNIQUE (COD_EDITOR, COD_REVISTA))

CREATE TABLE EDITOR_MIDIA (
COD_EDITOR INT REFERENCES EDITOR NOT NULL,
COD_MIDIA INT REFERENCES MIDIA NOT NULL,
UNIQUE (COD_EDITOR, COD_MIDIA))

CREATE TABLE PALAVRA_CHAVE_TITULOS (
COD_PALAVRA_CHAVE INT REFERENCES PALAVRA_CHAVE NOT NULL,
COD_TITULO INT REFERENCES TITULOS NOT NULL,
